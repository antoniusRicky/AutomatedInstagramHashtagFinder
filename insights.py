...
print
"\t" + response['json_data']['data'][0]['permalink']  # link to post
print
"\n\tPost caption:"  # post caption
print
"\t" + response['json_data']['data'][0]['caption']  # post caption
print
"\n\tMedia Type:"  # type of media
print
"\t" + response['json_data']['data'][0]['media_type']  # type of media
print
"\n\tPosted at:"  # when it was posted
print
"\t" + response['json_data']['data'][0]['timestamp']  # when it was posted
